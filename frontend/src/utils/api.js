const BASE_URL_API = "http://localhost:5001";
...
export const NOTE_EDIT_URL = BASE_URL_API + "/notes/edit";
export const NOTE_UPDATE_URL = BASE_URL_API + "/notes/update";

export const NOTE_DELETE_URL = BASE_URL_API + "/notes/delete";
